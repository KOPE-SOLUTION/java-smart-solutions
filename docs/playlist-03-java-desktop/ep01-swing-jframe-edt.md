...
Playlist 3 จะใช้ไฟล์ Lab แบบไม่ใส่ `package` เหมือน Playlist ก่อนหน้า ให้สร้างไฟล์ทั้งหมดไว้ในโฟลเดอร์เดียวกัน เช่น `src/main/java/labs`
...
งานที่ใช้เวลานาน เช่น Database, HTTP หรือ MQTT ไม่ควรทำค้างบน EDT เพราะหน้าต่างจะกดไม่ได้และดูเหมือนโปรแกรมค้าง เราจะกลับมาแยกงานใน EP3.9
